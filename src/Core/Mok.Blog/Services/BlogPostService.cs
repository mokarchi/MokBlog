...
namespace Mok.Blog.Services
{
    public class BlogPostService : IBlogPostService
    {
        ...
        /// and throws <see cref="MokException"/> if not found.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        /// <exception cref="MokException">if post is not found.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Returns a <see cref="BlogPost"/> by slug and date time, throws <see cref="MokException"/> if not found.
        ...
        public async Task<BlogPost> GetAsync(string slug, int year, int month, int day)
        {
            ...
            if (post == null) throw new MokException(EExceptionType.ResourceNotFound);
        ...
        {
            if (categorySlug.IsNullOrEmpty()) throw new MokException("Category does not exist.");
        ...
        {
            if (tagSlug.IsNullOrEmpty()) throw new MokException("Tag does not exist.");
        ...
        {
            if (!year.HasValue) throw new MokException("Year must be provided.");
        ...
        /// <summary>
        /// Returns a <see cref="Post"/> from data source, throws <see cref="MokException"/> if not found.
        /// </summary>

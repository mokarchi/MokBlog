...
namespace Mok.Blog.Services.Interfaces
{
    ...
    {
        /// <summary>
        /// Returns a <see cref="Category"/> by id, throws MokException is category not found.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        /// <remarks>
        ...
        /// <summary>
        /// Returns a <see cref="Category"/> by slug, throws MokException is category not found.
        /// </summary>
